...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .requestMatchers("/member/modify-info", "/member/modify-password", "/member/delete", "/member/info").hasAnyAuthority("Admin", "User")
                .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html", "/webjars/**").permitAll()
                .requestMatchers("/music/upload", "/music/modify", "/music/delete/{musicId}", "/music/info/{musicId}").hasAnyAuthority("Admin")
